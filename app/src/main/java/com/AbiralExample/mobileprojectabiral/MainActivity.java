    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewGrid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, gridAdapterView.class);
        ...
        viewList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, listAdapterView.class);
                intent.putStringArrayListExtra("dataList", dataList);
                startActivity(intent);
            }
        });
        ...
        viewRecycle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, recyclerAdapterView.class);
                intent.putStringArrayListExtra("dataList", dataList);
                startActivity(intent);
